...
public class Spinning : MonoBehaviour {
	...
	public GameObject WinMovieTexture;
	public GameObject LoseMovieTexture;
...
public void Update () 
	...
	public void gameOver(bool isSuccessful) {		
		...
		if(!isSuccessful){
			...
			LoseMovieTexture.active=true;
			Invoke("LoadMainLevel", 6.0f );
		} else {
			
			WinMovieTexture.active=true;
			Invoke("LoadMainLevel", 47.0f);
		}
